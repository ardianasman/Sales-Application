...
<!doctype html>
    ...
    <body>
        ...
        <div class="d-flex">
            ...
            <div class="p-3" style="margin-left: 280px;">
                ...
                <form class="d-flex mt-4 align-items-center">
                    ...
                    <button class="btn btn-outline-danger" type="button" id="add-product-btn">+ Add</button>
                </form>
        ...
        <!-- Add Product MODAL -->
        <div class="modal fade show" id="add-product-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-modal="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-sm">Harga Produk</span>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-warning mt-5" id="add-product-submit-btn" name="submit" style="width: 200px; margin-left: 450px;">Submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Edit Product MODAL -->
        <div class="modal fade show" id="edit-product-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-modal="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title" style="color: black;">EditProduct</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" id="edit-id_produk" name="id" value="">
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-sm">Nama Produk</span>
                            </div>
                            <input type="text" class="form-control" id="edit-nama_produk" name="nama_produk" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-sm">Harga Produk</span>
                            </div>
                            <input type="text" class="form-control" id="edit-harga_produk" name="harga_produk" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                        
                    <div class="modal-footer">
                        <button type="button" class="btn btn-warning mt-5" id="edit-product-submit-btn" name="submit" style="width: 200px; margin-left: 450px;">Submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach(function(product){
                            ...
                            edit.data('id_produk', product['id_produk']);
                            edit.data('nama_produk', product['nama_produk']);
                            edit.data('harga_produk', product['harga_produk']);
            ...
            $("#product-content").on("click", "[id='edit-btn']", function(){
                var id_produk = $(this).data('id_produk');
                var nama_produk = $(this).data('nama_produk');
                var harga_produk = $(this).data('harga_produk');
                
                $("#edit-id_produk").val(id_produk);
                $("#edit-nama_produk").val(nama_produk);
                $("#edit-harga_produk").val(harga_produk);
            ...
            $("#edit-product-submit-btn").click(function(){
                var id_produk = $("#edit-id_produk").val();
                var nama_produk = $("#edit-nama_produk").val();
                var harga_produk = $("#edit-harga_produk").val();
